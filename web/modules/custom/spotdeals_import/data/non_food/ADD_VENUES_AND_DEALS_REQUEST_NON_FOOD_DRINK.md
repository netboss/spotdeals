...
HIGHER PRIORITY: Find hair salons, barber shops, nail salons, pet grooming in CITY, STATE and surrounding areas
2nd HIGHER PRIORITY: Find massage therapists, escape rooms, bowling alleys, spas, dog daycare	weekly, car wash/detailing, local attractions etc.

Deals in CITY, STATE
Hair salons in CITY, STATE
Daily Specials in CITY, STATE
Nail salons in CITY, STATE
Local attractions in CITY, STATE
...
field_menu_url = list of services page when available
field_cta = only real user action like reserve
...
Services/order links belong only in the venue row fields.
